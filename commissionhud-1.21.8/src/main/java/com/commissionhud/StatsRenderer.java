...
public class StatsRenderer {
    ...
    public static void render(DrawContext context, StatsManager statsManager) {
        ...
        // Title
        context.drawText(client.textRenderer, Text.literal("Stats:"), 0, y, ensureAlpha(cfg.statsTitleColor), true);
        y += 12;
        ...
        for (Map.Entry<String, String> entry : stats.entrySet()) {
            ...
            int statColor = ensureAlpha(statsManager.getColorForStat(statName));
            ...
            context.drawText(client.textRenderer, Text.literal(labelText), 0, y, ensureAlpha(cfg.statsLabelColor), true);
