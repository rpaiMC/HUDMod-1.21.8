...
public class PositionScaleScreen extends Screen {
    ...
    private void renderCommissionPreview(DrawContext context, ConfigManager.Config cfg) {
        ...
        int y = 0;
        context.drawText(textRenderer, Text.literal("Commissions:"), 0, y, ensureAlpha(cfg.titleColor), true);
        y += 12;
        ...
        int[] exampleColors = {ensureAlpha(cfg.color), 0xFFFFFF55, 0xFF55FF55, ensureAlpha(cfg.color)};
        ...
        for (int i = 0; i < commissionCount; i++) {
            ...
            if (cfg.showPercentage) {
                ...
                int barColor = progress >= 100 ? 0xFF55FF55 : ensureAlpha(cfg.progressBarColor);
    ...
    private void renderPowderPreview(DrawContext context, ConfigManager.Config cfg) {
        ...
        context.drawText(textRenderer, Text.literal("Powder:"), 0, 0, ensureAlpha(cfg.powderTitleColor), true);
        
        String mithrilLabel = "Mithril: ";
        String mithrilValue = "123,456";
        int mithrilLabelWidth = textRenderer.getWidth(mithrilLabel);
        context.drawText(textRenderer, Text.literal(mithrilLabel), 0, 12, ensureAlpha(cfg.powderLabelColor), true);
        context.drawText(textRenderer, Text.literal(mithrilValue), mithrilLabelWidth, 12, ensureAlpha(cfg.powderValueColor), true);
        
        String gemstoneLabel = "Gemstone: ";
        String gemstoneValue = "78,901";
        int gemstoneLabelWidth = textRenderer.getWidth(gemstoneLabel);
        context.drawText(textRenderer, Text.literal(gemstoneLabel), 0, 22, ensureAlpha(cfg.powderLabelColor), true);
        context.drawText(textRenderer, Text.literal(gemstoneValue), gemstoneLabelWidth, 22, ensureAlpha(cfg.powderValueColor), true);
        ...
        if (cfg.powderCalcEnabled) {
            ...
            context.drawText(textRenderer, Text.literal(mithrilRateLabel), 0, nextY, ensureAlpha(cfg.powderLabelColor), true);
            ...
            context.drawText(textRenderer, Text.literal(gemstoneRateLabel), 0, nextY, ensureAlpha(cfg.powderLabelColor), true);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        int statsHeight = (int)(45 * cfg.statsScale);
